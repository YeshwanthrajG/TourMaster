...
public class DomesticTamilNadu extends JFrame {
    ...
    DomesticTamilNadu() {
        ...
        setTitle("Travel Agency - Tamil Nadu");
        setSize(1536, 864);
        setLocationRelativeTo(null);
        setResizable(false);
        setLayout(null);

        ImageIcon bgImage = new ImageIcon(getClass().getResource("/TamilNadu.jpg"));
        Image img = bgImage.getImage().getScaledInstance(getWidth(), getHeight(), Image.SCALE_SMOOTH);
        ...
        label1 = new JLabel("3 Packs Available for Tamil Nadu Tour!");
        ...
        label3 = new JLabel("<html>* First Class<br>* 5 Star Hotel<br>* By Train<br>* 6 Persons<br>* 10 Days<br>* Cost: ₹60,000</html>");
        ...
        label3_1 = new JLabel("<html>* Second Class<br>* 4 Star Hotel<br>* By Train<br>* 4 Persons<br>* 7 Days<br>* Cost: ₹45,000</html>");
        ...
        label3_2 = new JLabel("<html>* Third Class<br>* 3 Star Hotel<br>* By Bus<br>* 3 Persons<br>* 5 Days<br>* Cost: ₹30,000</html>");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            DomesticTamilNadu frame = new DomesticTamilNadu();
            frame.setVisible(true);
        });
    }
}
